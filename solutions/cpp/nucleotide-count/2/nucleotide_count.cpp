...
char to_upper(char c) { return static_cast<char>(std::toupper(static_cast<unsigned char>(c))); } // Uppercase conversion, for convenience. This is just to help filter data, though it is probably unnecessary in this solution.    
