...
namespace estate_executor
{
    ...
    int assemble_code()
    {
        int fragmentSum_Blu{ khan::blue::code_fragment() + garcia::blue::code_fragment() + zhang::blue::code_fragment() };
        int fragmentSum_Red{ khan::red::code_fragment() + garcia::red::code_fragment() + zhang::red::code_fragment() };        
        return fragmentSum_Blu * fragmentSum_Red;
    }
}